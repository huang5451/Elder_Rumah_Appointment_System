...
$query="SELECT * FROM customer_table WHERE Ic='$ic'";
...
<div id="slideshow"> 
    ...
    <input type="submit" value="Show Password" name="btnReset"/>
	</form>
...
Hi <?php echo $row['Ic'];?> , your password is <?php echo $row['Password'];?>
