...
.body1
{
	background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(old_man_bg_up.jpg);
...
<body class="body1">
  ...
  //header('Location: .php');
	...
	<div id="wrapper">
		...
		<?php if (!empty($_SESSION["username"])){?>
            <div id = "content1">
            <a href="Appointment.php"><div id = "box1">
                <br/><br/><br/><br/><br/><h1>Appointments</h1>
            </div></a>
            <a href="assignment_view.php"><div id = "box2">
                <br/><br/><br/><br/></br><h1>Checked Appointment</h1>
            </div></a>
		</div>
		<?php } else {?>
      
			<div class="title">
			<h1>Press Log in to book appointment</h1></div>
	
		
		<div class="button">
     	<a href="assignment_login.php"  target="_blank" class="btn">Log In</a>
