...
<?php echo ' <h2>Registration  <img height="60" src="signup.png" width="60" /></h2>';?>
<form action="#" method="get">
		...
		Address :<br/>
		<textarea name="txtAddress" clos="50" rows="5" ></textarea>
		<br/>
...
<?php
  ...
  $sqlQuery =" INSERT INTO `customer_table`(`First Name`, `Last Name`, `Ic`,`Gender`, `Password`, `Email`, `Address`) 
  VALUES ('$fname','$lname','$ic','$gender','$password','$email','$address')";
