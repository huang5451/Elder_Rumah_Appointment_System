...
?>
<?php
//Step1 -create a connection to ypur database
    $hostname = 'localhost';//'127.0.0.1'
    $usename = 'root';
    $password = '';
    $database = 'elder_rumah';
    $connection = mysqli_connect($hostname, $usename, $password, $database);
    if ($connection === false){
...
// step 2- create an sql command - SELECT, UPDATE, INSERT, DELETE
$sqlQuery = "SELECT * FROM customer_table WHERE Ic = '$ic'";
...
<body class="body1">
    ...
    <a href="index.php"><img class="square" src="old_man_logo.jpg" alt="old_man_logo" title="elder_rumah_system"/>
        ...
        <form action = "#" method='get'>
            Enter IC: <input type="text" name="txtIc">
            <input type="submit" value="Submit" name="btnDisplay">
        </form>
        </div>
        <div id = "backbutton">
        ...
        <?php while($row = mysqli_fetch_assoc($result)) {?>
            <tr>
                <td>
                    <a href="AdminAppointmentCheckUserDetailsedit.php?id=<?php echo $row['Customer_ID']; ?>">
