...
<div id="wrapper">
		...
		<div id="header2">
			<a href="Home.html"><img class="square" src="old_man_logo.jpg" alt="old_man_logo" title="elder_rumah_system"/>
		...
		<div id="nav">
			<ul>
				...
				<li><a href="admin_viewappointment.php">Check Booked Appointment</a></li>
...
<div id="slideshow"> 
    <div id="innercontent">
        <br/><br/>
<script>
//validate your passwords with js
...
<?php
    ...
    $query = "UPDATE customer_table SET 'Password' ='$pass'
    WHERE Ic='$ic"; //this is scene 2
...
<form action="#" method="post" onsubmit="">
    New Password: <input type="password" name="txtPassword" id="txtPassword">
    <br>
    Confirm Password : <input type="password" name="txtCPassword" id="txtcPassword">
    <br>
